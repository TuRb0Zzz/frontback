...
const swaggerOptions = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'API магазина с JWT и refresh-токенами',
      version: '1.0.0',
      description: 'API для управления пользователями и товарами с access/refresh токенами',
    },
    servers: [
      {
...
app.post("/api/auth/refresh", (req, res) => {
  ...
  try {
    ...
    //удаляем старый refresh-токен, создаём новый
