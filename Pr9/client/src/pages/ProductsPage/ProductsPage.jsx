...
export default function ProductsPage({ token, user, onLogout }) {
  ...
  const handleSubmit = async (productData) => {
    try {
      if (modalMode === 'create') {
        const newProduct = await api.createProduct(token, productData);
        setProducts(prev => [...prev, newProduct]);
      } else {
        const updatedProduct = await api.updateProduct(token, productData.id, productData);
